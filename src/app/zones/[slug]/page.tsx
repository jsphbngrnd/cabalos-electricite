...
export default async function ZonePage({
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: `Les tarifs dépendent de la nature des travaux. Emma établit un devis gratuit et détaillé avant toute intervention. Pour le dépannage : à partir de 120 € TTC en journée à Marseille (majoration de 30 % pour les communes alentours). Pas de mauvaise surprise : le prix annoncé est le prix facturé.`,
    },
  ];
