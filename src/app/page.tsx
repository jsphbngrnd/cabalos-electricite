          ...
          {SERVICES.map((s) => (
            <Link key={s.n} href={`/prestations#${s.slug}`} className="block">
              <div className="row grid grid-cols-12 gap-4 lg:gap-10 py-6 lg:py-7 items-start border-b border-[var(--border)]">
                ...
                <h3 className="col-span-10 lg:col-span-4 font-display text-[19px] lg:text-[22px] font-medium leading-snug">
                  {s.t}
                </h3>
                <div className="col-span-12 lg:col-span-5 text-[15px] leading-[1.55] text-[var(--muted-foreground)] max-w-[52ch]">
                  {s.d}
                  {s.price && (
