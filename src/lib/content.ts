...
export const PARCOURS = [
  ...
  {
    titre: "Aujourd'hui",
    texte: "Je réunis tout ce parcours : la curiosité du travail manuel, la rigueur des matériaux, la pédagogie de l'enseignement et la précision du métier d'électricienne.",
  },
];
